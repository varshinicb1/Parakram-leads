  ...
  return (
    <div className="flex flex-col items-center gap-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm">
              ...
              <div className="relative z-10 text-center px-6">
                {phase === "dead" && (
                  ...
                  <p className="text-[#10b981] text-xs font-mono mb-2">Score: {score}</p>
                  {score >= highScore && score > 0 && <p className="text-[#f5e4a8] text-[10px] font-mono mb-2 animate-pulse">NEW HIGH SCORE!</p>}
                  <p className="text-[#10b981] text-[10px] font-mono mb-6">Best: {highScore}</p></>
                )}
                {phase === "idle" && (
                  <><p style={{ fontFamily: "'Press Start 2P', monospace" }} className="text-[#c9a96e] text-sm mb-4 leading-loose">PARAKRAM'S QUEST</p>
                  <p className="text-[#10b981] text-xs font-mono mb-1">Explore the island. Find the treasure!</p>
                  <p className="text-[#10b981] text-xs font-mono mb-1">Watch for snakes. Use detector.</p>
                  <p className="text-[#10b981] text-xs font-mono mb-1">Arrows/WASD to move · Space/E to dig</p>
                  <p className="text-[#10b981] text-[10px] font-mono mb-6">Best: {highScore}</p></>
                )}
      ...
      <div className="flex items-center justify-between w-full px-1">
        ...
        <span className={`text-[10px] font-mono ${proximity === "BURNING!" ? "text-red-400 animate-pulse" : proximity === "HOT!" ? "text-orange-400" : proximity === "Warm" ? "text-yellow-500" : "text-[#10b981]"}`}>[{proximity || "---"}]</span>
        <span className="text-[11px] font-mono text-[#10b981]">LV {level}</span>
      </div>
