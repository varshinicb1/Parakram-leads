      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-[380px_1fr] gap-10 mb-20">
          <Panel title="meet.the.founder" className="p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[12px] text-[#10b981] mb-5">Full-Stack Developer · Systems Designer · Builder</p>
          ...
          <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                {skills.map(({ label, val }) => (
                  <div key={label} className="flex items-center gap-3">
                    <span className="text-[11px] text-[#10b981] w-56 flex-shrink-0">{label}</span>
            ...
            <Panel title="lore.txt" className="p-7">
              <div className="space-y-3">
                ...
                ].map((p, i) => <p key={i} className="text-[13px] text-[#10b981] leading-relaxed">{p}</p>)}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.04]">
          {[
            ...
            <div key={t} className="bg-[#070707] p-7"><Icon size={16} className="text-[#c9a96e] mb-4" /><h3 className="text-[14px] font-semibold text-[#c8c6c3] mb-2">{t}</h3><p className="text-[12px] text-[#10b981] leading-relaxed">{d}</p></div>
          ))}
        </div>
      </div>
    </div>
