...
from app.api.v1 import leads, auth, messages, alerts, webhooks, scraper, organizations, intelligence, audit, vps_subscription, vps_telemetry, edge_fabric, store, jobs, capabilities, projects
...
app.include_router(edge_fabric.router, prefix="/api/v1")
